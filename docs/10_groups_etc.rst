...
.. parsed-literal::
    ...
    ** Quasigroup **
    ...
    Commutative? No
    Cyclic?: Yes
    Generators: ['a2', 'a1', 'a5', 'a6', 'a7', 'a9', 'a3', 'a4', 'a8']
...
.. parsed-literal::
    ...
    sg.closure('a', 'b', 'c') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('a', 'b', 'f') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('a', 'e', 'f') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('b', 'c', 'd') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('b', 'd', 'f') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('c', 'd', 'e') = ['c', 'd', 'f', 'e', 'b', 'a']
    sg.closure('d', 'e', 'f') = ['c', 'd', 'f', 'e', 'b', 'a']
...
- ``generate_symmetric_group(n)``: :math:`S_n`, where :math:`\circ` is
  ...
  :math:`n!`
- ``generate_alternating_group(n)``: :math:`A_n`, where :math:`\circ` is
  composition of **even** permutations of :math:`(0, 1, ..., n-1)`;
  order is :math:`n!/2`
...
.. parsed-literal::
    ...
    '<Group:Z2, ID:4964192992>'



Autogenerated Symmetric & Alternating Groups
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The symmetric group, based on the permutations of n elements, (1, 2, 3,
…, n), can be generated as follows:

**WARNING**: Since the order of an alternating or symmetric group
involves **n!**, even a small value of **n** can result in a very large
group.

.. code:: ipython3

    >>> from finalg import generate_symmetric_group, generate_alternating_group
...
.. parsed-literal::
    ...
    ** Group **
    Name: A3
    Instance ID: 4964575312
    Description: Autogenerated alternating Group on 3 elements
    Order: 3
    Identity: '(0)(2)'
    Commutative? Yes
    Cyclic?: Yes
    Generators: ['(0 2 1)', '(0 1 2)']
    Elements:
       Index   Name   Inverse  Order
          0 '(0)(2)' '(0)(2)'       1
          1 '(0 1 2)' '(0 2 1)'       3
...
.. code:: ipython3
    ...
    >>> from finalg import generate_powerset_group
...
.. code:: ipython3
    ...
    >>> from finalg import generate_commutative_monoid
...
.. parsed-literal::
    ...
    '<Group:Z2_x_Z2_x_Z2, ID:4964578032>'
...
**WARNING**: The method ``isomorphic`` is deprecated and will eventually
be replaced with ``fast_isomorphic``.

.. code:: ipython3

    >>> z2_sqr = z2 * z2
    
    >>> v4.fast_isomorphic(z2_sqr)
...
``finalg.about_subalgebras`` finds and summarizes all proper subalgebras
...
.. code:: ipython3
    ...
    >>> partitions = about_subalgebras(ps3)
...
.. parsed-literal::
    ...
    7 Isomorphic Commutative Normal Groups of order 4 with identity '{}':
          ...
          Group: PS3_subalgebra_2: ('{}', '{2}', '{0, 1}', '{0, 1, 2}')
          Group: PS3_subalgebra_3: ('{}', '{0, 1}', '{0, 2}', '{1, 2}')
          Group: PS3_subalgebra_5: ('{}', '{1}', '{0, 2}', '{0, 1, 2}')
    ...
    7 Isomorphic Commutative Normal Groups of order 2 with identity '{}':
          ...
          Group: PS3_subalgebra_6: ('{}', '{0, 1, 2}')
          Group: PS3_subalgebra_7: ('{}', '{0, 2}')
          Group: PS3_subalgebra_10: ('{}', '{2}')
          Group: PS3_subalgebra_12: ('{}', '{1, 2}')
          Group: PS3_subalgebra_13: ('{}', '{0}')
    


If the actual subalgebras themselves are desired. They are contained in
the list ``partitions``, computed above, which now consists of two
sublists, where each sublist contains isomorphic algebras, as described
...
.. parsed-literal::
    ...
    Subalgebras of Example 1.4.1 : See: Groupoids and Smarandache Groupoids by W. B. Vasantha Kandasamy
      ...
      There are 3 unique proper subalgebras, up to isomorphism, out of 7 total subalgebras.
      as shown below:
    ...
    3 Isomorphic Commutative Groups of order 2:
          Group: Example 1.4.1_subalgebra_1: ('b', 'e') with identity 'e'
...
The ``finalg`` module contains a built-in dictionary of examples.

A table of contents of the examples can be obtained as follows:
...
.. parsed-literal::
    ...
    19: S3Y -- Yet another version of the symmetric group on 3 letters
    ======================================================================
...
.. code:: ipython3
    ...
    >>> alg = fg.examples[3]  # i.e., the 4th algebra in the list, above.
