...
.. parsed-literal::
    ...
    ** Quasigroup **
    ...
    Commutative? No
    Cyclic?: Yes
    Generators: ['a7', 'a1', 'a4', 'a2', 'a8', 'a5', 'a6', 'a3', 'a9']
...
.. parsed-literal::
    ...
    sg.closure('a', 'b', 'c') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('a', 'b', 'f') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('a', 'e', 'f') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('b', 'c', 'd') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('b', 'd', 'f') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('c', 'd', 'e') = ['e', 'f', 'd', 'b', 'c', 'a']
    sg.closure('d', 'e', 'f') = ['e', 'f', 'd', 'b', 'c', 'a']
...
.. parsed-literal::
    ...
    '<Group:Z2_x_Z2_x_Z2, ID:5097991024>'
...
.. parsed-literal::
    ...
    7 Isomorphic Commutative Normal Groups of order 4 with identity '{}':
          ...
          Group: PS3_subalgebra_11: ('{}', '{1}', '{0, 2}', '{0, 1, 2}')
          Group: PS3_subalgebra_13: ('{}', '{0}', '{1}', '{0, 1}')
    
    7 Isomorphic Commutative Normal Groups of order 2 with identity '{}':
          Group: PS3_subalgebra_1: ('{}', '{2}')
          Group: PS3_subalgebra_2: ('{}', '{1}')
