...
- [Sawyer 1978] “A Concrete Approach to Abstract Algebra”, Sawyer, W.W.,
...
- `Groups of small
  ...
  Florida
- `List of small
  groups <https://en.wikipedia.org/wiki/List_of_small_groups>`__: Finite
  groups of small order up to group isomorphism
- Klein four-group, V4
...
- `“Rings and
  ...
  John O’Connor & Edmund Robertson, School of Math. & Stat., Univ. of St
  Andrews, Scotland
